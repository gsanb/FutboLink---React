export default function Footer() {
  return (
    <footer className="footer p-10 bg-base-300 text-base-content grid grid-cols-1 md:grid-cols-4 gap-6">
      <nav>
        <header className="footer-title">Servicios</header> 
        <a className="link link-hover">Equipos</a>
        <a className="link link-hover">Jugadores</a>
        <a className="link link-hover">Ofertas</a>
        <a className="link link-hover">Estadísticas</a>
      </nav> 
      <nav>
      ...
      <aside>
        <p>© 2025 FutboLink<br/>Todos los derechos reservados</p>
      </aside>
    </footer>
  );
}
